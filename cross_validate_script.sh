					...
					do
						...
						do
                            ...
                            do
                                ...
                                basename=`./name.sh ${algorithm} ${classfold} ${C} ${foldnum} ${randomness} ${h} ${l} ${prox_weight}`
                                j=`echo $num_neg $num_pos | awk '{print $1/$2;}'`	
                                commands[1]=" --h $h --j $j --l $l --p ${prox_weight} "
                                commands[2]=" --h $h --j $j --l $l --p ${prox_weight} -m .1 -k 50 "
                                commands[3]=" --h $h --j $j --l $l --p ${prox_weight} -m .1 -k 50 -z 1 "
